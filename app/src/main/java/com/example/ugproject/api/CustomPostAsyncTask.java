...
public class CustomPostAsyncTask extends AsyncTask<Void, Void, String> {
    ...
    public CustomPostAsyncTask(Context context, String url, JSONObject requestBodyJson,
    ...
    protected String doInBackground(Void... voids) {
        try {
            ...
            Log.e("CustomPostAsyncTask", "Error al realizar la petición POST: " + e.toString());
            return e.toString();
        }
    }
